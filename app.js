...
// Configuration
// All API calls are handled by Netlify serverless function (/.netlify/functions/generate)
// This keeps the API key secure on the server side and never exposed to the browser
...
// Generate projects using Netlify serverless function - ALWAYS USES REAL AI
...
async function generateProjects(formData) {
    ...
    try {
        // Try Netlify serverless function first (production)
        ...
        throw new Error(`Failed to generate projects: ${error.message}. Please check your internet connection and ensure the Netlify dev server is running.`);
    }
}
